export const experiences = [
  {
    title: ".NET Developer",
    company_name: "NYC Department Of Socail Services",
    icon: {
    ...
    points: [
      "Developing and maintaining web applications using .NET and other related technologies related to Databases",
      "Collaborating with cross-functional teams including designers, product managers, and other developers to create high-quality products.",
      "Implementing responsive design and ensuring cross-browser compatibility.",
      "Participating in code reviews and providing constructive feedback to other developers.",
      "Integrated third-party APIs and services to enhance application functionality and improve data exchange."
    ]
  },
  {
    ...
    points: [
      "Developed and implemented software solutions for CME Group, a leading global financial exchange and trading technology company.",
      "Collaborated with cross-functional teams to design and deliver high-performance software applications that meet the company's trading and risk management needs.",
